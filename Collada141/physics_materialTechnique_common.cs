...
namespace Collada141
{
  ...
  public class physics_materialTechnique_common
  {
    ...
    {
      get => this.dynamic_frictionField;
      set => this.dynamic_frictionField = value;
    }

    public TargetableFloat restitution
    {
      get => this.restitutionField;
      set => this.restitutionField = value;
    }

    public TargetableFloat static_friction
    {
      get => this.static_frictionField;
      set => this.static_frictionField = value;
    }
  }
}
