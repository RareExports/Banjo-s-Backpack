...
// Type: BanjoKazooieLevelEditor.BKSkyBox
...
{
  public class BKSkyBox
  {
    public int skyBoxModel;
    public string mapName = "";
    public int secondarySkyBoxModel;
    public int thirdSkyBoxModel;
    public int sceneID;
    public short scaleSB1;
    public short scaleSB2;
    public short scaleSB3;
    public string SB1Name = "";
    public string SB2Name = "";
    public string SB3Name = "";

    public BKSkyBox(
      int sceneID_,
      int skyBoxModel_,
      int secondarySkyBoxModel_,
      int thirdSkyBoxModel_,
      short scaleSB1_,
      short scaleSB2_,
      short scaleSB3_)
    {
      this.sceneID = sceneID_;
      this.skyBoxModel = skyBoxModel_;
      this.secondarySkyBoxModel = secondarySkyBoxModel_;
      this.thirdSkyBoxModel = thirdSkyBoxModel_;
      this.scaleSB1 = scaleSB1_;
      this.scaleSB2 = scaleSB2_;
      this.scaleSB3 = scaleSB3_;
      this.setMapName();
      this.SB1Name = this.setName(this.skyBoxModel);
      this.SB2Name = this.setName(this.secondarySkyBoxModel);
      this.SB3Name = this.setName(this.thirdSkyBoxModel);
    }
    ...
    public string setName(int id_)
    {
      ...
      switch (id_)
      {
        ...
        case 1992:
          ...
          break;
        case 1993:
          str = "Sky - Intro \"N\" Cube";
          break;
        case 1994:
          str = "Sky - Grunty's Lair - MMM Entrance";
          break;
        case 1995:
          str = "Sky - Grunty's Lair - MMM Entrance - Clouds";
          break;
        case 1996:
          str = "Sky - Witch Faling Towards Ground";
          break;
        case 1997:
